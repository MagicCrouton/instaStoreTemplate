...
import { categories, collections} from './tempdata/tempdata'
 ...
 {/* end mobile menu */}
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          <h1 className="text-4xl font-bold tracking-tight text-white lg:text-6xl">Welcome to BoloLama</h1>
          <p className="mt-4 text-xl text-white">
            We stock hand made baby alpaca goods hats blankets etc etc..
          </p>
          <a
            href="#"
